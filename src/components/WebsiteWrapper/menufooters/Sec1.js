	          ...
	          <ul className="xoxo">
	            <li id="text-10" style ={{listStyleType: 'none'}}className="widget-container widget_text">
	              <div className="footer-middle-colum1">
                    <div className="footer-middle-colum-title">
                      <h4  >
                        <a href="https://batdongsan.com.vn/nha-dat-ban-tp-hcm">KHU VỰC TP HCM</a>
                      </h4>
                    </div>
                    ...
                    <div className="footer-menu-column">
                      <a href="https://batdongsan.com.vn/ban-nha-rieng-quan-8">Bán nhà Quận 8</a>
                    </div>
                    <div className="footer-menu-column">
                    ...
                    <div className="footer-menu-column">
                      <a href="https://batdongsan.com.vn/ban-nha-rieng-quan-12">Bán nhà Quận 12</a>
                    </div>
                    <div className="footer-menu-column">
                    ...
                    <div className="footer-menu-column">
                      <a href="https://batdongsan.com.vn/nha-dat-ban-binh-tan">Bán nhà Bình Tân</a>
                    </div>
                    <div className="footer-menu-column">
                      <a href="https://batdongsan.com.vn/ban-can-ho-chung-cu-thu-duc">Chung cư Thủ Đức</a>
                    </div>
                    <div className="footer-menu-column">
                      <a href="https://batdongsan.com.vn/ban-can-ho-chung-cu-quan-9">Chung cư Quận 9</a>
                    </div>
                    <div className="footer-menu-column">
