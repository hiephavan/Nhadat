...
class Sec4 extends Component {
  ...
  <div className="footer-menu-column">
    <a href="https://batdongsan.com.vn/cho-thue-nha-rieng-tp-hcm">Cho thuê nhà Hồ Chí Minh</a>
  </div>
  <div className="footer-menu-column">
  ...
  <div className="footer-menu-column">
    <a href="https://batdongsan.com.vn/cho-thue-nha-rieng-hai-phong">Cho thuê nhà Hải Phòng</a>
  </div>
  <div className="footer-menu-column">
  ...
  <div className="footer-menu-column">
    <a href="https://batdongsan.com.vn/cho-thue-nha-rieng-tan-binh">Cho thuê nhà Tân Bình</a>
  </div>
  <div className="footer-menu-column">
    <a href="https://batdongsan.com.vn/cho-thue-nha-rieng-binh-thanh">Cho thuê nhà Bình Thạnh</a>
  </div>
  <div className="footer-menu-column">
  ...
  <div className="footer-menu-column">
    <a href="https://batdongsan.com.vn/cho-thue-nha-tro-phong-tro-quan-7">Nhà trọ Quận 7</a>
  </div>
  <div className="footer-menu-column">
    <a href="https://batdongsan.com.vn/ban-can-ho-chung-cu-charm-resort-long-hai">Charm Long Hải Resort </a>
  </div>
  <div className="clear">
    &nbsp;
  </div>
