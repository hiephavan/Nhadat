	    	...
	    	<div className="master_header wide topbar_transparent">
			    <div className="mobile_header">
			      ...
			      <div className="mobile-logo">
			        				<a href="https://paris.wpresidence.net/">
			    ...
			    <div className="header_wrapper header_type5 header_center hover_type_1 header_alignment_text_left navbar-fixed-top customnav">
		           			...
		           			<ul id="menu-main-menu" className="menu">
		           				...
		           				<ul style={{}} className="  sub-menu ">
			           				<li id="menu-item-18439" className="menu-item menu-item-type-custom menu-item-object-custom   ">
				           				<a className="menu-item-link" target="_blank" href="https://wpresidence.net/">Cho thuê</a>
				           			</li>
			           			...
			           			<ul style={{}} className="  sub-menu ">
			           				...
			           				<li id="menu-item-19544" className="menu-item menu-item-type-post_type menu-item-object-page no-megamenu   ">
				           				<a className="menu-item-link" href="https://paris.wpresidence.net/blog-list-sidebar-left/">Trả góp</a>
				           			</li>
			           				<li id="menu-item-18380" className="menu-item menu-item-type-post_type menu-item-object-page with-megamenu   ">
				           				<a className="menu-item-link" href="https://paris.wpresidence.net/contact-us-3/">Du thuyền</a>
				           			</li>
				           			<li id="menu-item-18380" className="menu-item menu-item-type-post_type menu-item-object-page with-megamenu   ">
